		  ...
		  <tr>
			<th>
  			...
  			<div <?php if ($errors['name']) {print 'class="error"';} ?>>
  				<input name="name" value="<?php print $values['name']; ?>" placeholder="FIO"/>
  			</div>
  			<br/>
  			<div <?php if ($errors['email']) {print 'class="error"';} ?>>
  				<input name="email" value="<?php print $values['email']; ?>" placeholder="xxx@mail.ru" />
  			</div>
  			<br />
  			<div <?php if ($errors['fieldname']) {print 'class="error"';} ?>>
  				<textarea name="fieldname" placeholder="Bio." value="<?php print $values['fieldname']; ?>"></textarea>
  			</div>
  			<br />
            ...
            <th>
                <label>
                    ...
                    checked="<?php if($values['sex'] == 'male'){print 'checked';} ?>"
                    name="sex" value="Male" /> Man
                </label>
                &emsp;&emsp;&emsp;
                <label>
                    <input type="radio" <?php if ($errors['sex']) {print 'class="error"';} ?>
                    name="sex" value="Female" /> Woman
                </label>
                <br /><br />
                ...
                <br />
                <label>
                    <input type="radio" checked="<?php if($values['limbs'] == 'One') {print 'checked';} ?>"
                ...
                <option value="Hyperspeed" >Hypersreed</option>
      		...
      		<label>
                <div <?php if ($errors['checks']) {print 'class="error"';}?>>
      			<input type="checkbox"
      			checked="<?php if($values['checks']) print 'checked'; ?>"
